...
class Fluxdata_Metadata:
    ...
    def write_metadata_from_xlsx(self):
        ...
        if isfile(outf):
            return
        fpath = join(self.data_dir, 'csv/AMF_AA-Net_BIF_CCBY4_20250201.xlsx')
...
class Fluxdata:
    ...
    def gen_dataframe(self):
        ...
        outf = join(outdir, f'{self.var}_{self.temporal_res}.df')
        T.save_df(df, outf)
